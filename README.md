...
- **Multi-Source Search** — Searches CrossRef, Google Scholar (SerpAPI, ScraperAPI, or Apify actor), and Google web search
...
- **Verification Sources**: CrossRef API, Google Scholar (SerpAPI / ScraperAPI / Apify), Google Web Search
...
- **多來源搜尋** — 搜尋 CrossRef、Google Scholar（SerpAPI、ScraperAPI 或 Apify actor）、Google 網頁搜尋
